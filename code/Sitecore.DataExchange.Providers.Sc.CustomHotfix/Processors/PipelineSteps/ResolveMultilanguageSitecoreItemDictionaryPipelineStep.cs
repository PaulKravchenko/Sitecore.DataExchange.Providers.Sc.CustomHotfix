...
namespace Sitecore.DataExchange.Providers.Sc.CustomHotfix.Processors.PipelineSteps
{
    public class ResolveMultilanguageSitecoreItemDictionaryPipelineStep : Sc.Processors.PipelineSteps.ResolveMultilanguageSitecoreItemDictionaryPipelineStep
    {
